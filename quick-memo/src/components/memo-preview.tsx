...
const MemoPreview = React.forwardRef<HTMLDivElement, MemoPreviewProps>(
    ({ memoData, onDownload, isGenerating = false }, ref) => {
        const {
            shopProfile,
            customer,
            products,
                            ...
                            <div className="p-6">
                                ...
                                <div className="mb-6">
                                    <table className="w-full border-collapse">
                                        ...
                                        <tbody>
                                            {products.filter(p => p.name && p.price > 0).map((product) => (
